...
import { FileIcon, FileTextIcon, FileSpreadsheetIcon, FileBarChart2Icon, FileArchiveIcon, FileVideoIcon, FileImageIcon, FileCodeIcon, FileAudioIcon, CalendarIcon, ClockIcon, UserIcon, HardDriveIcon, SparklesIcon, CopyIcon, CheckIcon } from 'lucide-react';
