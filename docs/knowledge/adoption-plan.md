...
Steps 1 through 3 establish the bundle structure, ADR concepts, and Phase 1 API group concepts. Existing project documentation remains canonical during the transition.
